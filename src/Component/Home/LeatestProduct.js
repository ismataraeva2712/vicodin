...
const LeatestProduct = ({leatestProduct}) => {
    const{name,genericName,price,previousPrice,picture}=leatestProduct
    return (
  ...
  <div className='flex'>
  <BsStarFill className='text-secondary text-lg ' />
  <BsStarFill className='text-secondary text-lg ' />
  <BsStarFill className='text-secondary text-lg ' />
  <BsStarFill className='text-secondary text-lg ' />
  <BsStarHalf className='text-secondary text-lg ' />
  </div>
